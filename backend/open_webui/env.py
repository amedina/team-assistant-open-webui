...
ENABLE_AGENT_ENGINE = os.environ.get("ENABLE_AGENT_ENGINE", "False").lower() == "true"
AGENT_ENGINE_PROJECT_ID = os.environ.get("AGENT_ENGINE_PROJECT_ID", "")
...
AGENT_ENGINE_SERVICE_ACCOUNT_JSON = os.environ.get("AGENT_ENGINE_SERVICE_ACCOUNT_JSON", "")
AGENT_ENGINE_WORKLOAD_IDENTITY_PROVIDER = os.environ.get("AGENT_ENGINE_WORKLOAD_IDENTITY_PROVIDER", "")
AGENT_ENGINE_WORKLOAD_IDENTITY_SERVICE_ACCOUNT = os.environ.get("AGENT_ENGINE_WORKLOAD_IDENTITY_SERVICE_ACCOUNT", "")
AGENT_ENGINE_CUSTOM_URL = os.environ.get("AGENT_ENGINE_CUSTOM_URL", "")
